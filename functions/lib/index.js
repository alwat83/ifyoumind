...
exports.recalcTrending =
  exports.onIdeaCreated =
  exports.toggleUpvote =
  exports.moderateDeleteIdea =
  exports.setAdmin =
  exports.setModerator =
    void 0;
...
exports.setModerator = (0, https_1.onCall)(async (req) => {
  ...
  if (!uid) throw new https_1.HttpsError("invalid-argument", "Missing uid");
 ...
 */
exports.onIdeaCreated = (0, firestore_1.onDocumentCreated)(
  "ideas/{ideaId}",
  async (event) => {
    var _a;
    const data =
 ...
 */
exports.recalcTrending = (0, scheduler_1.onSchedule)(
  "every 60 minutes",
  async () => {
    const db = admin.firestore();
