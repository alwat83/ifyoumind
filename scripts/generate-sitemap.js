...
try {
  if (process.env.FIREBASE_SERVICE_ACCOUNT) {
    ...
    console.log(
      "Initialized Firebase Admin with service account from environment variable.",
    );
  } else {
  ...
  console.error(
    "Please ensure you have either set the FIREBASE_SERVICE_ACCOUNT environment variable or have a valid serviceAccountKey.json file in the root directory.",
  );
