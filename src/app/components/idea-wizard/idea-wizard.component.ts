...
export class IdeaWizardComponent {
  ...
  categories = [
    ...
    { id: 'environment', name: 'Environment', icon: '🌱', color: 'from-green-500 to-emerald-500' },
    { id: 'health', name: 'Health', icon: '🏥', color: 'from-red-500 to-pink-500' },
    { id: 'education', name: 'Education', icon: '📚', color: 'from-purple-500 to-indigo-500' },
    { id: 'social', name: 'Social', icon: '🤝', color: 'from-orange-500 to-yellow-500' },
    { id: 'business', name: 'Business', icon: '💼', color: 'from-gray-500 to-slate-500' },
    { id: 'general', name: 'General', icon: '💡', color: 'from-indigo-500 to-purple-500' }
  ];
  ...
  async submitIdea() {
    ...
    try {
      ...
      if (currentUser) {
        ...
        // Trigger celebration
        const submitButton = document.querySelector('.submit-wizard-button') as HTMLElement;
        if (submitButton) {
