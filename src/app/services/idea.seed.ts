...
export const IDEA_SEED_DATA = [
  {
    ...
    problem: 'People can’t easily see cross-domain progress on climate, health, and education.',
    solution: 'Unified open API + rolling visualization fed by trusted datasets.',
  ...
  },
  {
    ...
    solution: 'Quantized edge models (WebAssembly) auto-updating in tiny delta bundles.',
  ...
  },
  {
    ...
    solution: 'Region-specific native seed + soil biome starter kits with app guidance.',
  ...
  },
  {
    ...
    solution: 'Offline-first localized app with staged pregnancy modules & SMS fallback.',
  ...
  },
  {
    ...
    solution: '10-minute rotating peer tutoring cycles guided by AI scaffold cards.',
  ...
  },
  {
    ...
    solution: 'Platform listing 15-minute actionable civic tasks with measurable impact.',
  ...
  },
  {
    ...
    solution: 'API generating standardized scope 1–3 carbon intensity labels per SKU.',
  ...
  },
  {
    ...
    solution: 'Wizard that outputs risk summary + mitigation plan + public transparency badge.',
